         ...
         completionHandler:(JFPaymentCompletionHandler)completionHandler
{
    ...
    [[HaiTunPay shareInstance] requestWithUrl:kPayUrl
                                       ...
                                       finish:^(NSData *data)
     {
         ...
         JFWebViewController *webVC = [[JFWebViewController alloc] initWithURL:url];
         webVC.title = @"微信支付";
...
- (void)checkPayment:(JFPaymentInfo *)paymentInfo withCompletionHandler:(JFPaymentCompletionHandler)completionHandler {
    ...
    [sessionManager POST:kQueryOrderUrl
                 ...
                 success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject)
     {
         ...
         SafelyCallBlock4(completionHandler, success ? PAYRESULT_SUCCESS : PAYRESULT_FAIL, paymentInfo);
